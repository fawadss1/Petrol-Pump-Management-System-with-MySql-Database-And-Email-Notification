...
try:
    ...
    if cnfrm_stock == "Y":
        ...
        Narrator("Invalid Key Try Again")
        print("*" + "~~" * 35 + "*")
    Narrator("Enter Your New Reading of Petrol 'A' Your Previous Reading is: " + str(pris_ptrl_rdng_A))
    crnt_ptrl_rdng_A = float(input())
    print("*" + "~~" * 35 + "*")
    Narrator("Enter Your New Reading of Petrol 'B' Your Previous Reading is: " + str(pris_ptrl_rdng_B))
    crnt_ptrl_rdng_B = float(input())
    print("*" + "~~" * 35 + "*")
    Narrator("Enter Your New Reading of Diesel 'A' Your Previous Reading is: " + str(pris_dsil_rdng_A))
    crnt_dsil_rdng_A = float(input())
    print("*" + "~~" * 35 + "*")
    Narrator("Enter Your New Reading of Diesel 'B' Your Previous Reading is: " + str(pris_dsil_rdng_B))
    crnt_dsil_rdng_B = float(input())
    print("*" + "~~" * 35 + "*")
    Narrator("Enter Your Total Expanses( ٹوٹل خرچہ ) :")
    total_expanses = float(input())
    print("*" + "~~" * 35 + "*")
    Narrator("Enter Your Total Cashback( ٹوٹل وصولی )  :")
    ...
    if cashback == 0:
        ...
        cashback_name = input()
        print("*" + "~~" * 35 + "*")
    Narrator("Enter Your Total Cash Out(ٹوٹل نقددیا )  :")
    cashout = float(input())
    if cashout == 0:
        print("*" + "~~" * 35 + "*")
        cashout_name = ""
